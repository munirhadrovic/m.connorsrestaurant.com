...
<html>
	...
	<body>
		...
		<div data-role="footer" data-theme="<?php echo $theme ?>" data-position="fixed">
			<h1 style="color:black;font-weight: bold">Powered by <a href="http://mobilegrows.com/" rel="external">MobileGrows</a> | <a href="http://www.connorsrestaurant.com/" rel="external">Desktop Site</a></h1>
		</div>
		<!-- page 1 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
...
<!-- pop up for telefon -->
			...
			<!-- POPUP FOR FIND US -->
				...
				<a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">MENUS</a>
              ...
              <a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">WINE & BAR</a>
              ...
              <a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">GIFT CARDS</a>
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu">
						<ul id="menu">
							...
							<li><a href="#page2" data-transition="<?php echo $transitionefect ?>">DESSERTS</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">WINE & BAR</a></li>
